...
## 沉浸式翻译
> 实际上前面的 AI 助手插件已经能解决大部分问题了，但是沉浸式翻译还是有它的优势，比如翻译PDF，电子书等。

- [网页翻译插件 - 沉浸式翻译双语对照](https://immersivetranslate.com/)
可以说是最好用的网页实时对照翻译插件了。支持网页端，手机端，最实用的是在网页上英汉对照，设定快捷键翻译网站非常快速，还有很多好用的翻译功能，翻译外语网页，PDF文档，ePub 电子书，字幕文件等。也支持 YouTube 在线视频的字幕实时翻译
